...
const items = [
  ...
  {'content' : '누구보다 빠르게 난 남들과는 다르게 색다르게 리듬을 타는 비트 위에 나그네', 'img' : '', 'likes': '5'},
  {'content' : '유후 앤 다하 잇츠 모얼 댄 라이크 L 다음 또 O 다음 나 예예예, 유후 앤 다하 잇츠 로얼 댄 라이크! 왓츠 애프터라이크', 'img' : 'logo.png', 'likes': '33'},
  {'content' : '가끔은 정말 헷갈리지만 분명한 건 Got me looking for attention', 'img' : 'logo.png', 'likes': '20'},
  {'content' : 'I worked my whole life just to get right, just to be like Look at me, I"m never coming down I worked my whole life Just to get high, just to realize Everything I need is on the Everything i need is on the ground', 'img' : 'logo.png', 'likes': '2'},
  {'content' : '어느 날 한라산 산삼이 먹고 싶다며 나를 데려간 제주도에서 저기 저 돌하르방 코는 아들 낳을 돌하르방 코인가 딸 낳을 돌하르방 코인가를 묻는 너를 보며 난 액자 속 사진을 찢어 버렸다 너와 헤어진 후 힘들어하는 내게 박 법학박사님과 백 법학박사님께서 차라리 상담담당 선생님 성 선생님을 추천해주셨어 그렇게 찾은 러브코치 상담담당 선생님 성 선생님이 내게 말했어 자기는 참치 꽁치찜을 좋아한다고 이게 무슨 헛소린가 싶어 난 청송콩찰떡이 좋다고 했지 시덥잖은 농담 속에 서울 찹쌀 촌 찹쌀같이 나눠져 있던 마음이 쿵더더덕 덩기더더덕 녹아버렸어 너로 인해 고장난 내 마음의 보일러 지금부터 난 난방방법 변경을 할 거야 공간 감각이 사라질 정도로 내 몸에서 합성 착향료가 날 때까지 (Brrr) 너랑 헤어진 후 난 편판선 군의 소개로 판편숙 양을 만났어 그녀는 간장공장 공장장의 친구 중앙청 창살 외창살 시청 창살 쌍창살을 관리했어', 'img' : 'logo.png', 'likes': '3'},
]
