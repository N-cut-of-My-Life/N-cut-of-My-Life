			...
			<ol>
					<li>
						<div>
							...
							<img class="planet" src="@/assets/planet/haho.png" style="width:12rem; height:12rem; border-radius:50%; transform: scale(0.65);">
					</li>
					<li>
						<div>
					...
					<li>
						<div>
							...
							<p class="ctnt">너의 가장 슬펐던 기억을<br> 적어주겠니?</p>
						</div>
							<img class="planet" src="@/assets/planet/weep.png" style="width:12rem; height:12rem; border-radius:50%; transform: scale(1);">
					</li>
					<li>
						<div>
							<p class="ttl">반짝반짝행성</p>
							<p class="ctnt">가장 소중히 여기는 물건이<br> 뭔지 적어주겠니?</p>
						</div>
					...
					<li>
						<div>
							...
							<p class="ctnt">이루지 못한꿈은 무엇이 있니?<br> 잠시 맡겨두어도 좋단다!</p>
						</div>
							<img class="planet" src="@/assets/planet/didnt.png" style="width:12rem; height:12rem; border-radius:50%; transform: scale(0.5);">
					</li>
					<li>
						<div>
							<p class="ttl">괜히글행성</p>
							<p class="ctnt">후회되는 일은 여기 있는<br> 후회쓰레기통에 버리고 가렴</p>
						</div>
							<img class="planet" src="@/assets/planet/forget.png" style="width:12rem; height:12rem; border-radius:50%; transform: scale(0.7);">
					</li>
					<li>
						<div>
							<p class="ttl">둠칫둠칫행성</p>
							<p class="ctnt">네가 가장 좋아하는 음악은<br> 무엇이니?</p>
						</div>
