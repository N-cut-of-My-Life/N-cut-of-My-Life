...
public class JwtTokenProvider {
	...
	private static final long accessTokenValidTime = 30 * 60 * 1000L;    // access 토큰 유효시간 30분
	private static final long refreshTokenValidTime = 14 * 24 * 60 * 60 * 1000L;    // refresh 토큰 유효시간 14일
